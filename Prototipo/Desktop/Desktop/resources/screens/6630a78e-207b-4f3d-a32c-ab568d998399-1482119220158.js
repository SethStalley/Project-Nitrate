jQuery("#simulation")
  .on("click", ".s-6630a78e-207b-4f3d-a32c-ab568d998399 .click", function(event, data) {
              ...
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/5c360eb5-ed43-4f90-9404-ad681fbc62af",
                    "tab": true
                  },
                  "exectype": "serial",
                  "delay": 0
  ...
  .on("pageload", ".s-6630a78e-207b-4f3d-a32c-ab568d998399 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
  ...
  .on("mouseleave dragleave", ".s-6630a78e-207b-4f3d-a32c-ab568d998399 .mouseleave", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
  ...
  .on("mouseenter dragenter", ".s-6630a78e-207b-4f3d-a32c-ab568d998399 .mouseenter", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getDirectEventFirer(this);
              ...
              "actions": [
                {
                  ...
                  "parameter": [ {
                    "#s-6630a78e-207b-4f3d-a32c-ab568d998399 #s-Text_2": {
                      "attributes": {
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-6630a78e-207b-4f3d-a32c-ab568d998399 #s-Text_3": {
                      "attributes": {
                        "background-color": "#999999",
                        "background-image": "none"
                      }
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-6630a78e-207b-4f3d-a32c-ab568d998399 #s-Text_4": {
                      "attributes": {
                        "background-color": "#999999",
                        "background-image": "none"
                      }
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-6630a78e-207b-4f3d-a32c-ab568d998399 #s-Text_13": {
                      "attributes": {
                        "background-color": "#999999",
                        "background-image": "none"
                      }
