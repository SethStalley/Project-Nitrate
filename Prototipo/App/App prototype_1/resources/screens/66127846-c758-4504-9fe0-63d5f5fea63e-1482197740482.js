jQuery("#simulation")
  .on("click", ".s-66127846-c758-4504-9fe0-63d5f5fea63e .click", function(event, data) {
  ...
  .on("pageload", ".s-66127846-c758-4504-9fe0-63d5f5fea63e .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
